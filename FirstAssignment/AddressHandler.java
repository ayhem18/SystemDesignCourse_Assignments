 ...
 * the address are assumed to be in the following form : City X Y
 * the city can be considered a grid with horizontal and vertical avenues
 * When changing the model. All the changes will be reflected only in this class.
 */
public class AddressHandler {
    ...
    public final static int NOT_SAME_CITY_CODE = Integer.MAX_VALUE;

    // remove all additional spaces including heading and trailing ones
    static String legitimateAddress(String address) {
     ...
     * @return a string representing the address's city
     */
     ...
     * @param address : either a patient's or a doctor address
     * @return a string representing the X avenue number
     */
     ...
     * @param address : either a patient's or a doctor address
     * @return a string representing the Y avenue number
     */
     ...
     * @return an integer representing the distance between the two addresses
     */
