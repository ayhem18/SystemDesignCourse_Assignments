...
public enum Gender {
    ...
    /**
     * this method assures passing sex as a string and getting the corresponding enum value
     * it filers additional spaces and ignores casing
     * @param string: the passed string as sex
     * @return the corresponding Gender value, the default is set to Gender.MALE
     */
