...
public class PredictionSystem {
    ...
    private static PredictionSystem predSys;
    ...
    /**
     * The method returns the single object of singleton class PredictionSystem
     * or creates this first instance if there was no one before
     * @return predSys
     */
    ...
    /**
     * The method finds from the diseasesDatabase the disease
     * that has the most symptoms identical to the symptoms of the patient.
