...
public class DoctorDatabase {
    ...
    private final static int MAX_X = 100;
    private final static int MAX_Y = 100;
    
    /**
     * private static database and private constructor and a single public entry point : Singleton pattern
     */
    private volatile static DoctorDatabase database;
    ...
    private DoctorDatabase() {
        CITIES = Arrays.asList("MOSCOW", "SAINT PETERSBURG", "NOVOSIBIRSK","YEKATERINBURG",
