...
public class DiseaseDatabase {
    ...
    private DiseaseDatabase (){
        ...
        data.add(new Disease("Stomach ulcer",
                ...
                "heartburn","nausea"));
        data.add(new Disease("Hepatitis B",
                """
        ...
        data.add(new Disease("Heart Cancer",
                """
        ...
        data.add(new Disease("lung cancer",
                """
    ...
    public void addDisease(String name, String info, String[] symptoms){
        data.add(new Disease(name, info, symptoms));
    }
}