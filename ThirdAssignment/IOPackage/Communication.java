...
public class Communication {
  ...
  private static final String NO_PARTNER_INSURANCE_COMPANY = "OTHER";
  ...
  private static final String SELECT_COMPANY =
      "PLEASE ENTER YOUR INSURANCE COMPANY NAME OR "
          + "ENTER "
          + NO_PARTNER_INSURANCE_COMPANY
          + " IF YOU COLLABORATE WITH ANOTHER AGENCY";

  private static final String INSURANCE_WARNING =
      "PLEASE MAKE SURE TO ENTER EITHER " + NO_PARTNER_INSURANCE_COMPANY + " OR ONE OF THE " + " OUR PARTNERS NAMES";
  ...
  public static String validateSex() {
  ...
  public static String validateCompanyName(List<String> names) {
    System.out.println(SELECT_COMPANY);
    String name = insuranceName(INPUT.nextLine());

    while (!(name.equals(NO_PARTNER_INSURANCE_COMPANY) || names.contains(name))) {
  ...
  public static void reactToName(String companyName) {
    if (companyName.equals(NO_PARTNER_INSURANCE_COMPANY)) {
  ...
  public static BasicClient registerClient(){
    Membership membership = Membership.getValue(Communication.validateMembership());
    BasicClient result;
    switch (membership){
      case BASIC -> result = new BasicClient();
      case PRO -> result = new ProClient();
      case PRO_PLUS ->  result = new ProPlusClient();
      default -> result = new PremiumClient();
    }
